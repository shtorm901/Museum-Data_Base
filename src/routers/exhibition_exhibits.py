...
from sql_base import Exhibition_exhibits
import resolvers.exhibition_exhibits
...
def new_exhibition_exhibits(exhibition_exhibits: Exhibition_exhibits):
    new_id = resolvers.exhibition_exhibits.new_exhibition_exhibits(exhibition_exhibits)
    return f'{{code: 201, id: {new_id}}}'


@exhib_router.get('/{exhibition_exhibits_id}')
def get_exhibition_exhibits(exhibition_exhibits_id: int):
    exhibition = resolvers.get.exhibition(exhibition_exhibits_id)
